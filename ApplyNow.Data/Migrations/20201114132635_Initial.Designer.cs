...
namespace ApplyNow.Data.Migrations
{
    ...
    [Migration("20201114132635_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplyNow.Core.Models.Announcement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CompanyId = 1,
                            CreatedDate = new DateTime(2020, 11, 4, 16, 26, 34, 758, DateTimeKind.Local).AddTicks(8060),
                            Description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua",
                            EndDate = new DateTime(2020, 11, 16, 16, 26, 34, 758, DateTimeKind.Local).AddTicks(8410),
                            Location = "İstanbul"
                        },
                        new
                        {
                            Id = 2,
                            CompanyId = 2,
                            CreatedDate = new DateTime(2020, 11, 4, 16, 26, 34, 758, DateTimeKind.Local).AddTicks(9000),
                            Description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua",
                            EndDate = new DateTime(2020, 11, 14, 16, 26, 34, 758, DateTimeKind.Local).AddTicks(9010),
                            Location = "İzmir"
                        });
                });
            ...
            modelBuilder.Entity("ApplyNow.Core.Models.Resume", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2020, 11, 14, 16, 26, 34, 753, DateTimeKind.Local).AddTicks(7850),
                            IsActive = false,
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2020, 11, 14, 16, 26, 34, 758, DateTimeKind.Local).AddTicks(1050),
                            IsActive = false,
                            Title = "Avukat",
                            UserId = 2
                        });
            ...
            modelBuilder.Entity("ApplyNow.Core.Models.Announcement", b =>
                {
                    b.HasOne("ApplyNow.Core.Models.Company", "Company")
            ...
            modelBuilder.Entity("ApplyNow.Core.Models.Apply", b =>
                {
                    b.HasOne("ApplyNow.Core.Models.Announcement", "Announcement")
                        .WithMany()
                        .HasForeignKey("AnnouncementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApplyNow.Core.Models.Resume", "Resume")
                        .WithMany()
